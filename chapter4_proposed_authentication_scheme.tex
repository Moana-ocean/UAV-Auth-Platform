...
The project does not invent a production service-level target before measuring the prototype. Instead, performance requirements ensure that the relevant costs are observable and that the system remains usable across the workload range defined in Chapter~\ref{chap:research-design-methodology}.
