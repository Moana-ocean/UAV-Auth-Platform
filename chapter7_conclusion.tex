...
\textbf{RQ3.} X.509 scaled to near 59.6~rps on the evaluation host with stable low-concurrency latency up to 500 identities. Blockchain throughput plateaued near 29~rps with pronounced latency growth under concurrent registry lookups.
